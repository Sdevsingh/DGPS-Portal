        ...
        <div className="max-w-3xl mx-auto px-4 py-6 md:py-8">
          <div className="bg-white/10 border border-white/20 backdrop-blur rounded-3xl p-5 md:p-6 text-white">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              ...
              <Link href="/jobs/new" className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-white text-blue-700 hover:bg-blue-50 rounded-xl text-sm font-semibold transition-colors shadow-sm shrink-0">
